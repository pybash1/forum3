    ...
    <div>
      ...
      <Sidebar
        links={[
          ...
          { name: "ForumPage", link: "/components/forum-page", active: true },
        ]}
      />
      <div className="pl-[280px] w-2/3 pt-20 font-inter">
        <div className="font-bold text-black text-4xl pt-16">Forum Page</div>
        <div className="text-[#464168] text-xl pt-5 pb-10 font-normal">
          The Forum Page component is a widget like embeddable component that lies at
